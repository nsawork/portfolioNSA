...
export const homePageStyles = {
  ...
  container:
    "relative min-h-screen bg-transparent p-4 md:p-8 pt-20 lg:pt-20 xl:pt-30",
  pageWrapper:
    "min-h-screen bg-gradient-to-br from-[#1c1208] via-[#3b2414] to-[#120b05]",
  ...
  // Gradient overlay
  gradientOverlay:
    "absolute inset-0 min-h-full bg-linear-to-b from-black/40 via-transparent to-black/60 pointer-events-none",
...
button:
  "mt-2 sm:mt-0 inline-flex items-center justify-center rounded-full border border-amber-400/40 bg-amber-400/10 px-5 py-2 text-sm font-medium text-amber-300 transition-all duration-300 hover:border-amber-300 hover:bg-amber-400/20 hover:text-white hover:shadow-[0_0_20px_rgba(251,191,36,0.15)] focus:outline-none focus:ring-2 focus:ring-amber-400/30 shrink-0",  },
...
specializationTitle:
  "mb-4 flex items-center justify-center gap-2 text-lg font-semibold text-emerald-400",
specializationBadgesContainer: "mt-3 flex flex-wrap justify-center gap-3",
specializationBadge:
  "inline-flex items-center gap-2 rounded-full border border-zinc-700 bg-zinc-900/50 px-4 py-2 text-sm font-medium text-zinc-300 transition-all duration-300 hover:border-zinc-500 hover:bg-zinc-800 hover:text-white",
...
export const contactPageStyles = {
  // Layout and container styles
  pageContainer:
    "relative flex min-h-screen w-full items-start justify-center px-6 py-12 pt-20 md:px-12 md:py-20 lg:px-16 bg-transparent",
  contentContainer: "w-full max-w-2xl",

  // Form container with boxes background
  formOuterContainer:
    "relative w-full overflow-hidden flex flex-col items-center justify-center bg-transparent",
  backgroundOverlay: "absolute inset-0 pointer-events-none bg-transparent",

  // Header
  headerContainer: "mb-12 relative z-10 flex flex-col items-center text-center",
  headerTitle:
    "text-5xl md:whitespace-nowrap z-30 font-bold tracking-tight text-zinc-100 md:text-6xl lg:text-7xl",
  headerSubtitle:
    "mt-5 max-w-xl mx-auto text-center text-base md:text-lg leading-relaxed text-zinc-400",
  ...
  // Contact method card
  contactCard:
    "group flex items-center justify-center gap-4 rounded-xl border border-zinc-800 bg-zinc-900/30 p-4 transition-all hover:border-zinc-700 hover:bg-zinc-900/50",
  ...
  // Form styles
  formContainer:
    "relative z-10 space-y-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 md:p-8",
  ...
  submitButton:
    "group relative w-full overflow-hidden rounded-xl border border-white/20 bg-white/10 px-8 py-4 text-sm font-semibold text-white backdrop-blur-md transition-all duration-300 hover:border-white/40 hover:bg-white/20 hover:shadow-[0_0_30px_rgba(255,255,255,0.25)] active:scale-95 md:w-auto",
  submitButtonText: "relative z-20 flex items-center justify-center gap-3",
...
export const styles = {
  ...
  container: "min-h-screen bg-zinc-950 p-4 md:p-8 pt-20 lg:pt-20 xl:pt-30",
  backgroundImage:
    "conic-gradient(from 290deg at 50% 0%, transparent, white, transparent)",

  headerLabel:
    "text-xs font-medium tracking-[0.45em] uppercase text-amber-400 opacity-90",

  mainTitle: "mt-4 text-4xl font-bold text-white md:text-5xl",
  instagramLink:
    "inline-flex items-center gap-1 transition-opacity hover:opacity-80 no-underline",

  instagramIcon: "h-4 w-4 text-orange-400",

  instagramText:
    "bg-gradient-to-r from-pink-500 via-purple-500 to-orange-400 bg-clip-text text-transparent underline decoration-orange-400 underline-offset-4",
...
export const commonStyles = {
  headerLabel:
    "text-2xl font-bold tracking-[0.45em] uppercase text-amber-400 opacity-90",
};
