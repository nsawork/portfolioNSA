...
export default function Sidebar(): React.ReactElement {
  ...
  const navItems: {
    ...
    { href: "/projects", label: "Projetos", Icon: ProjectsIcon },
    { href: "/experience", label: "Experiência", Icon: ExperienceIcon },
    { href: "/tools", label: "Ferramentas", Icon: ToolsIcon },
    { href: "/about", label: "Sobre mim", Icon: UserIcon },
    { href: "/contact", label: "Contato", Icon: MailIcon },
  ];
    ...
    <>
      <div className={s.mobileTopNav}>
        <div className={s.mobileTopNavInner}>
          <div className={s.mobileAvatarContainer}>
            ...
            <div>
              <div className={s.mobileName}>Nicolas Sá</div>
              <TypingAnimation
      ...
      <aside className={s.desktopSidebar} aria-labelledby="desktop-sidebar">
        <div className={s.desktopAvatarContainer}>
          ...
          <div>
            <div className={s.desktopName}>Nicolas Sá</div>
            <TypingAnimation
        ...
        >
          ...
          <div className={s.connectLabel}>Contato</div>
      ...
      >
        <div
          className={`${s.mobileOverlayBg} ${
            isMobileMenuOpen
              ? s.mobileOverlayBgVisible
              : s.mobileOverlayBgHidden
          }`}
        ...
        <div
          className={`${s.mobileSidebar} ${
            isMobileMenuOpen ? s.mobileSidebarVisible : s.mobileSidebarHidden
          }`}
        >
          ...
          <div className={s.mobileFooter}>
            <div className={s.mobileFooterLabel}>Entre em contato →</div>

            <div className={s.mobileFooterText}>
              <div>Made by Nicolas ® 2026</div>
            </div>
          </div>
        </div>
      </div>
